    ...
    experiences: [
      {
        ...
        achievements: [
          ...
          'DX 향상을 위한 프론트엔드 템플릿 구성 및 배포',
          'GitLab CI와 Docker를 활용한 자동화된 테스트·배포 및 환경 컨테이너화 구현',
          'PostgreSQL 벡터 검색과 OpenAI API를 활용한 문서 기반 질의응답 챗봇 시스템 구현',
          '웹 성능 최적화',
        ],
      },
      {
        ...
        achievements: [
          ...
          '공통 함수 및 유틸리티 모듈 구현',
          'OAuth2 기반 구글 소셜 로그인 기능 구현 및 인증 토큰 처리',
        ],
      },
    ],
  },
